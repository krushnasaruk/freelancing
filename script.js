// Initialize EmailJS
(function() {
    emailjs.init("FrBZHo5tuocz2tTPYo"); // Your EmailJS public key
})();
...
contactForm.addEventListener('submit', function(e) {
    ...
    submitBtn.disabled = true;
        ...
        emailjs.send('service_contact', 'template_2ie6nvn', formObject, 'FrBZHo5tuocz2tTPYo')
            .then((response) => {
...
if (reviewForm) {
    reviewForm.addEventListener('submit', function(e) {
        ...
        const reviewObject = {
            ...
            to_name: 'Dr. Manisha Munde',
            message_type: 'Review Submission',
        ...
        emailjs.send('service_contact', 'template_2ie6nvn', reviewObject, 'FrBZHo5tuocz2tTPYo')
            .then((response) => {
